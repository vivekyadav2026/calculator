...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h3 class="fw-bold mb-0 text-dark">Edit Calculator: <?php echo htmlspecialchars($data['calculator']->name); ?></h3>
        ...
        <div class="card border-0">
            ...
            <div class="card-body p-4">
                <form action="<?php echo URLROOT; ?>/admin/edit_calculator/<?php echo $data['calculator']->id; ?>" method="POST">
                    <div class="mb-4">
                        <label class="form-label fw-medium text-dark mb-1" style="font-size: 0.875rem;">Calculator Name</label>
                        <input type="text" name="name" class="form-control" value="<?php echo htmlspecialchars($data['calculator']->name ?? ''); ?>" required>
                    </div>

                    <div class="mb-4">
                        <label class="form-label fw-medium text-dark mb-1" style="font-size: 0.875rem;">Description</label>
                        <textarea name="description" class="form-control" rows="3"><?php echo htmlspecialchars($data['calculator']->description ?? ''); ?></textarea>
                    </div>

                    <div class="mb-4">
                        <label class="form-label fw-medium text-dark mb-1" style="font-size: 0.875rem;">Status</label>
