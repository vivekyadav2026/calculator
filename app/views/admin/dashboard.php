...
<div class="row g-4 mb-4">
    <div class="col-md-3">
        <div class="card border-0 p-4 h-100">
            ...
            <h2 class="fw-bold mb-0 "><?php echo isset($data['total_calculators']) ? number_format($data['total_calculators']) : 0; ?></h2>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card border-0 p-4 h-100">
            ...
            <h2 class="fw-bold mb-0 "><?php echo isset($data['total_posts']) ? number_format($data['total_posts']) : 0; ?></h2>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card border-0 p-4 h-100">
            ...
            <h2 class="fw-bold mb-0 "><?php echo isset($data['page_views']) ? number_format($data['page_views']) : 0; ?></h2>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card border-0 p-4 h-100">
    ...
    <div class="card-body p-0">
        <div class="p-4 border-bottom" style="border-color: #E5E7EB;">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <p class="mb-0 fw-medium ">System initialized successfully.</p>
        ...
        <div class="p-4">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <p class="mb-0 fw-medium ">Admin logged in.</p>
