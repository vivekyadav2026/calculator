            ...
            <div class="card calc-card shadow-sm border-0 h-100">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center gap-3 mb-4">
                        ...
                        <div>
                            <h1 class="fw-bold h3 mb-1">EMI Calculator</h1>
                            <p class="text-muted small mb-0">Equated Monthly Installment</p>
                        </div>
                    </div>
                    ...
                    <form id="emi-calculator-form">
                        ...
                        <div class="mb-4">
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <span class="text-primary fw-bold" id="emi-amount-val">₹1,000,000</span>
                            </div>
                            <input type="range" class="form-range" id="emi-amount" min="10000" max="50000000" step="10000" value="1000000">
                            <div class="input-group mt-2">
                                <span class="input-group-text">₹</span>
                                <input type="number" class="form-control" id="emi-amount-input" value="1000000" min="10000">
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <span class="text-success fw-bold" id="emi-rate-val">8.5%</span>
                            </div>
                            <input type="range" class="form-range" id="emi-rate" min="1" max="25" step="0.1" value="8.5">
                            <div class="input-group mt-2">
                                <input type="number" class="form-control" id="emi-rate-input" value="8.5" step="0.1" min="1" max="25">
                                <span class="input-group-text">%</span>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <span class="text-warning fw-bold" id="emi-tenure-val">10 Years</span>
                            </div>
                            <input type="range" class="form-range" id="emi-tenure" min="1" max="30" step="1" value="10">
                            <div class="input-group mt-2">
                                <input type="number" class="form-control" id="emi-tenure-input" value="10" min="1" max="30">
                                <select class="form-select" id="emi-tenure-type" style="max-width: 120px;">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            <div class="p-3 bg-primary-subtle rounded-3 text-center">
                                <span class="text-primary-emphasis d-block small mb-1">Monthly EMI</span>
                                <span class="fw-bold fs-4 text-primary" id="res-emi-monthly">₹0</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="p-3 bg-light rounded-3 text-center">
                                <span class="text-muted d-block small mb-1">Total Principal</span>
                                <span class="fw-bold fs-5 text-body" id="res-emi-principal">₹0</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="p-3 bg-light rounded-3 text-center">
                                <span class="text-muted d-block small mb-1">Total Interest</span>
                                <span class="fw-bold fs-5 text-danger" id="res-emi-interest">₹0</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="p-3 bg-success-subtle rounded-3 text-center">
                                ...
                                <span class="fw-bold fs-5 text-success" id="res-emi-total">₹0</span>
                            </div>
                        </div>
                    </div>
