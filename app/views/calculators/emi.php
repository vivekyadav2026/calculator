                    ...
                    <form id="emi-calculator-form">
                        ...
                        <div class="mb-4 bg-white p-3 border rounded shadow-sm">
                            <div class="d-flex justify-content-between mb-2">
                                <label class="form-label fw-bold mb-0 text-dark">Loan Amount</label>
                                <span class="text-primary fw-bold" id="emi-amount-val">₹1,000,000</span>
                            </div>
                            <input type="range" class="form-range mb-2" id="emi-amount" min="10000" max="50000000" step="10000" value="1000000">
                        ...
                        <div class="mb-4 bg-white p-3 border rounded shadow-sm">
                            ...
                            <input type="range" class="form-range mb-2" id="emi-rate" min="1" max="25" step="0.1" value="8.5">
                            <div class="input-group">
                        ...
                        <div class="mb-0 bg-white p-3 border rounded shadow-sm">
                            ...
                            <input type="range" class="form-range mb-2" id="emi-tenure" min="1" max="30" step="1" value="10">
                            <div class="input-group">
                                <input type="number" class="form-control" id="emi-tenure-input" value="10" min="1" max="30">
                                <select class="form-select bg-light" id="emi-tenure-type" style="max-width: 120px;">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            <div class="p-3 bg-white border rounded shadow-sm text-center">
                                <span class="text-muted fw-bold d-block small text-uppercase mb-1">Monthly EMI</span>
                        ...
                        <div class="col-md-6">
                            <div class="p-3 bg-white border rounded shadow-sm text-center">
                                ...
                                <span class="fw-bold fs-5 text-dark" id="res-emi-principal">₹0</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="p-3 bg-white border rounded shadow-sm text-center">
