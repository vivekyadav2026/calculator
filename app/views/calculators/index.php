    ...
    <div class="row g-4 mb-5">
        ...
        <div class="col-md-6 col-xl-3">
            <div class="category-card h-100">
                ...
                <h3 class="category-title" id="financial" style=" font-weight: 700;">Financial & Banking</h3>
                <div class="d-flex flex-wrap gap-2 mt-3">
                    ...
                    <a href="<?php echo URLROOT; ?>/home-loan-calculator" class="btn btn-sm btn-outline-primary rounded-pill px-3 py-1">Home Loan</a>
                    <a href="<?php echo URLROOT; ?>/car-loan-calculator" class="btn btn-sm btn-outline-primary rounded-pill px-3 py-1">Car Loan</a>
                    <a href="<?php echo URLROOT; ?>/personal-loan-calculator" class="btn btn-sm btn-outline-primary rounded-pill px-3 py-1">Personal Loan</a>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="category-card h-100">
                ...
                <h3 class="category-title" style=" font-weight: 700;">Investment & Tax</h3>
                <div class="d-flex flex-wrap gap-2 mt-3">
                    <a href="<?php echo URLROOT; ?>/sip-calculator" class="btn btn-sm btn-outline-success rounded-pill px-3 py-1">SIP Calculator</a>
                    <a href="<?php echo URLROOT; ?>/compound-interest-calculator" class="btn btn-sm btn-outline-success rounded-pill px-3 py-1">Compound Interest</a>
                    <a href="<?php echo URLROOT; ?>/simple-interest-calculator" class="btn btn-sm btn-outline-success rounded-pill px-3 py-1">Simple Interest</a>
                    <a href="<?php echo URLROOT; ?>/income-tax-calculator" class="btn btn-sm btn-outline-success rounded-pill px-3 py-1">Income Tax</a>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="category-card h-100">
                ...
                <h3 class="category-title" id="health" style=" font-weight: 700;">Health & Fitness</h3>
                <div class="d-flex flex-wrap gap-2 mt-3">
        ...
        <div class="col-md-6 col-xl-3">
            <div class="category-card h-100">
                ...
                <h3 class="category-title" id="math" style=" font-weight: 700;">Math & Others</h3>
                <div class="d-flex flex-wrap gap-2 mt-3">
