            ...
            <div class="card calc-card shadow-sm border-0 h-100">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center gap-3 mb-4">
                        ...
                        <div>
                            <h1 class="fw-bold h3 mb-1">Compound Interest</h1>
                            <p class="text-muted small mb-0">Calculate exponential compounding returns</p>
                        </div>
                    </div>
                    ...
                    <form id="ci-calculator-form">
                        ...
                        <div class="mb-4">
                            <label class="form-label fw-bold">Compounding Frequency (n)</label>
                            <select class="form-select" id="ci-n-custom">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-4">
                            <div class="p-3 bg-light rounded-3 text-center">
                                ...
                                <span class="fw-bold fs-5 text-body" id="res-ci-principal">₹0</span>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="p-3 bg-light rounded-3 text-center">
                        ...
                        <div class="col-md-4">
                            <div class="p-3 bg-success-subtle rounded-3 text-center">
                                ...
                                <span class="fw-bold fs-5 text-success" id="res-ci-total">₹0</span>
                            </div>
                        </div>
                    </div>
