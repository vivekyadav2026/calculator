            ...
            <div class="card calc-card shadow-sm border-0 h-100">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center gap-3 mb-4">
                        ...
                        <div>
                            <h1 class="fw-bold h3 mb-1">Personal Loan</h1>
                            <p class="text-muted small mb-0">Calculate monthly unsecured loan EMIs</p>
                        </div>
                    </div>
                    ...
                    <form id="personal-loan-calculator-form">
                        ...
                        <div class="mb-4">
                            <div class="d-flex justify-content-between mb-2">
                                <label class="form-label fw-bold mb-0">Loan Amount</label>
                                <span class="text-primary fw-bold" id="pl-amount-val">₹200,000</span>
                            </div>
                            <input type="range" class="form-range" id="pl-amount" min="10000" max="5000000" step="5000" value="200000">
                            <div class="input-group mt-2">
                                <span class="input-group-text">₹</span>
                                <input type="number" class="form-control" id="pl-amount-input" value="200000" min="10000">
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            <div class="d-flex justify-content-between mb-2">
                                <label class="form-label fw-bold mb-0">Interest Rate (p.a.)</label>
                                <span class="text-success fw-bold" id="pl-rate-val">12%</span>
                            </div>
                            <input type="range" class="form-range" id="pl-rate" min="5" max="30" step="0.1" value="12">
                            <div class="input-group mt-2">
                                <input type="number" class="form-control" id="pl-rate-input" value="12" step="0.1" min="5" max="30">
                                <span class="input-group-text">%</span>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            <div class="d-flex justify-content-between mb-2">
                                <label class="form-label fw-bold mb-0">Loan Tenure</label>
                                <span class="text-warning fw-bold" id="pl-tenure-val">3 Years</span>
                            </div>
                            <input type="range" class="form-range" id="pl-tenure" min="1" max="7" step="1" value="3">
                            <div class="input-group mt-2">
                                <input type="number" class="form-control" id="pl-tenure-input" value="3" min="1" max="7">
                                <select class="form-select" id="pl-tenure-type" style="max-width: 120px;">
            ...
            <div class="card calc-card shadow-sm border-0 h-100">
                <div class="card-body p-4">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            <div class="p-3 bg-primary-subtle rounded-3 text-center">
                                <span class="text-primary-emphasis d-block small mb-1">Monthly Personal EMI</span>
                                <span class="fw-bold fs-4 text-primary" id="res-pl-monthly">₹0</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="p-3 bg-light rounded-3 text-center">
                                <span class="text-muted d-block small mb-1">Total Principal</span>
                                <span class="fw-bold fs-5 text-body" id="res-pl-principal">₹0</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="p-3 bg-light rounded-3 text-center">
                                <span class="text-muted d-block small mb-1">Total Interest</span>
                                <span class="fw-bold fs-5 text-danger" id="res-pl-interest">₹0</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="p-3 bg-success-subtle rounded-3 text-center">
                                <span class="text-success-emphasis d-block small mb-1">Total Amount Payable</span>
                                <span class="fw-bold fs-5 text-success" id="res-pl-total">₹0</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-4 align-items-center">
                        <!-- Bar Chart -->
                        <div class="col-md-7">
                            <h6 class="fw-bold text-center mb-2">Loan Amortization Growth</h6>
                        ...
                        <!-- Pie Chart -->
                        <div class="col-md-5">
                            <h6 class="fw-bold text-center mb-2">Payment Breakup</h6>
