                ...
                <div class="literal-calc-body flex-grow-1 p-4" style="background-color: #e5e5e5; border-radius: 0 0 4px 4px;">
                    <form id="personal-loan-calculator-form">
                        ...
                        <div class="mb-4 bg-white p-3 border rounded shadow-sm">
                            ...
                            <input type="range" class="form-range mb-2" id="pl-amount" min="10000" max="5000000" step="5000" value="200000">
                        ...
                        <div class="mb-4 bg-white p-3 border rounded shadow-sm">
                            ...
                            <input type="range" class="form-range mb-2" id="pl-rate" min="5" max="30" step="0.1" value="12">
                            <div class="input-group">
                        ...
                        <div class="mb-0 bg-white p-3 border rounded shadow-sm">
                            ...
                            <input type="range" class="form-range mb-2" id="pl-tenure" min="1" max="7" step="1" value="3">
                            <div class="input-group">
                                <input type="number" class="form-control" id="pl-tenure-input" value="3" min="1" max="7">
                                <select class="form-select bg-light" id="pl-tenure-type" style="max-width: 120px;">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            <div class="p-3 bg-white border rounded shadow-sm text-center">
                                <span class="text-muted fw-bold d-block small text-uppercase mb-1">Monthly Personal EMI</span>
                        ...
                        <div class="col-md-6">
                            <div class="p-3 bg-white border rounded shadow-sm text-center">
                                ...
                                <span class="fw-bold fs-5 text-dark" id="res-pl-principal">₹0</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="p-3 bg-white border rounded shadow-sm text-center">
