                    ...
                    <form id="personal-loan-calculator-form">
                        ...
                        <div class="mb-3">
                            <label class="form-label d-flex justify-content-between  mb-1" style="font-size: 0.9rem; font-weight: 600;">
                                ...
                                <span class="text-primary" id="pl-amount-val">â‚¹500,000</span>
                            </label>
                    ...
                    <div class="row g-2 mb-3">
                        <div class="col-md-6">
                            ...
                            <div class="literal-calc-displays" style="height: auto; padding: 6px 12px; margin-bottom: 0;">
                                <div class="literal-display-main text-primary fs-5 text-end" id="res-pl-monthly">â‚¹0</div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label  mb-1" style="font-size: 0.9rem; font-weight: 600;">Total Principal</label>
                            <div class="literal-calc-displays" style="height: auto; padding: 6px 12px; margin-bottom: 0;">
                                <div class="literal-display-main  fs-5 text-end" id="res-pl-principal">â‚¹0</div>
                            </div>
                        </div>
                        <div class="col-md-6 mt-2">
                            <label class="form-label  mb-1" style="font-size: 0.9rem; font-weight: 600;">Total Interest</label>
                            <div class="literal-calc-displays" style="height: auto; padding: 6px 12px; margin-bottom: 0;">
                                <div class="literal-display-main text-danger fs-5 text-end" id="res-pl-interest">â‚¹0</div>
                            </div>
                        </div>
                        <div class="col-md-6 mt-2">
                            ...
                            <div class="literal-calc-displays" style="height: auto; padding: 6px 12px; margin-bottom: 0; background-color: #f8f9ff;">
                                <div class="literal-display-main text-success fs-5 text-end" id="res-pl-total">â‚¹0</div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card shadow-none border rounded-4">
                <div class="card-body p-4 p-md-5">
                    ...
                    <ul class="text-muted text-start">
                        <li class="mb-2"><strong>P (Principal):</strong> The total amount borrowed. Usually ranges from â‚¹10,000 to â‚¹40 Lakhs.</li>
                    ...
                    <p class="text-muted">Let's calculate the EMI for a Personal Loan of <strong>â‚¹2 Lakhs</strong> at <strong>12% p.a.</strong> interest rate for a tenure of <strong>3 Years</strong>:</p>
                    <ol class="text-muted text-start">
                        <li class="mb-2"><strong>P</strong> = â‚¹2,00,000</li>
                        ...
                        <li class="mb-2">This results in a monthly payment of approximately <strong>â‚¹6,643</strong>.</li>
                    </ol>
